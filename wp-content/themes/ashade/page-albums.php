 ...
 * Template Name: Ashade Albums Listing
 */
...
if ( 'ribbon' == $type ) {
    ...
    if ( 'vertical' == $style && $title_state == true ) {
        ?>
        <!-- Content -->
    ...
    <div class="ashade-albums-carousel-wrap">
		<div class="ashade-albums-carousel is-<?php echo esc_attr( $style ); ?>" id="albums_carousel">
    <?php
} else if ( 'slider' == $type ) {
				...
				<section class="ashade-section">
					<div class="ashade-row">
						<div class="ashade-col col-12">
							<p class="ashade-intro align-<?php echo esc_attr( $intro_align ); ?> limit-width-<?php echo esc_attr( $intro_width ); ?>"><?php echo esc_html( $intro_text ); ?></p>
						</div>
					</div>
				</section>
                <?php } ?>
