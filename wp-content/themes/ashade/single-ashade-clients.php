			...
			<div class="ashade-content-scroll">
				...
				<div class="ashade-content">
					...
					<section class="ashade-section">
						<div class="ashade-row">
							<div class="ashade-col col-12">
								<p class="ashade-intro align-<?php echo esc_attr( $intro_align ); ?>"><?php echo esc_html( $intro ); ?></p>
							</div><!-- .ashade-col -->
						</div><!-- .ashade-row -->
					...
					<div class="
							...
							<?php echo ( 'adjusted' == $gallery_type ? 'ashade-gallery-adjusted' : '' ); ?>" data-id="<?php echo esc_attr( get_the_ID() ); ?>">
					<?php						
					}
					...
					if ( Ashade_Core::get_prefer( 'ashade-client-comments' ) == true ) {
						comments_template();
					}
					?>
				</div><!-- .ashade-content -->
