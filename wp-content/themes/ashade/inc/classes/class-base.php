	...
	final class Ashade_Core {
		...
		public static function get_body_class() {
			$this_body_class = array(
				'ashade-body',
				( self::get_mod( 'ashade-protection-rclick' ) == true ? 'ashade-rcp' : null ),
				( self::get_mod( 'ashade-protection-drag' ) == true ? 'ashade-idp' : null ),
				...
				( self::get_mod( 'ashade-smooth-scroll' ) == true ? 'ashade-smooth-scroll' : null ),
				( self::get_mod( 'ashade-lightbox-zoom' ) == true ? 'ashade-pswp-zoomable' : null ),
				( self::get_mod( 'ashade-header-sticky' ) == true ? 'ashade-header-sticky' : 'ashade-header-scrollable' ),
			);
			if ( is_home() ) {
				# Default Blog Listing
				if ( self::get_mod('ashade-spotlight') == true )
					array_push( $this_body_class, 'has-spotlight' );
				if ( self::get_mod('ashade-listing-cu') == true )
				...
				# Single Post Listing
				if ( self::get_prefer('ashade-spotlight') == true )
					array_push($this_body_class, 'has-spotlight');
				if ( 'ashade-albums' == get_post_type() ) {
					# Albums Post Type
					if ( self::get_prefer( 'ashade-albums-cu' ) == true )
						array_push( $this_body_class, 'no-header-padding' );
					...
					if ( self::get_mod( 'ashade-albums-back-state' ) == true ) {
					...
					# Client Post Type
					if ( self::get_prefer('ashade-client-cu') == true )
						array_push( $this_body_class, 'no-header-padding' );
					...
					if ( self::get_prefer( 'ashade-post-cu' ) == true )
						array_push( $this_body_class, 'no-header-padding' );
				...
				if ( self::get_prefer( 'ashade-spotlight' ) == true )
					array_push( $this_body_class, 'has-spotlight' );
				if ( self::get_prefer( 'ashade-page-cu' ) == true )
					array_push( $this_body_class, 'no-header-padding' );
		...
		public static function get_menu_wrap() {
			...
			if ( self::get_mod('ashade-aside-state') == true ) {
				if ( self::get_mod('ashade-aside-label-type') == true ) {
					$menu_wrap .= '
