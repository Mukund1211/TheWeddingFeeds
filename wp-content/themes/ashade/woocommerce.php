	...
	?>
		<main id="page-<?php the_ID(); ?>" <?php post_class( 'ashade-content-wrap' ); ?>>
			<div class="ashade-content-scroll">
				...
				?>
				<div class="ashade-content ashade-woo-content <?php echo (esc_attr( $sale_labels == true ) ? 'show-sale-labels' : 'hide-sale-labels'); ?> <?php echo (esc_attr( $sold_labels == true ) ? 'show-sold-labels' : 'hide-sold-labels'); ?>">
