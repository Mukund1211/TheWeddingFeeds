...
class Shadow_Gallery_Masonry_Widget extends Widget_Base {
	
	public function get_name() {
		return 'shadow-gallery-masonry';
	}
	
	public function get_title() {
		return esc_html__( 'Gallery: Masonry', 'shadowcore' );
	}
	...
	protected function _register_controls() {		
		...
		$this->add_control(
            ...
            [
				...
				'description' => esc_html__( 'Preview height will set automatically to keep image ratio.', 'shadowcore' ),
                'default' => '960',
                'min' => '100',
				'step' => '1',
				'condition' => [
			...
			<div class="shadowcore-gallery-item shadowcore-grid-item">
				<div class="shadowcore-gallery-item__inner">
					<a 	href="<?php echo esc_url( $image_url ); ?>" 
						...
						data-gallery = "masonry_<?php echo esc_attr( $this->get_id() ); ?>" 
...
Plugin::instance()->widgets_manager->register_widget_type( new Shadow_Gallery_Masonry_Widget() );