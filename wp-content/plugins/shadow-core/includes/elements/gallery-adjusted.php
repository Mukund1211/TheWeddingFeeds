...
class Shadow_Gallery_Adjusted_Widget extends Widget_Base {
	
	public function get_name() {
		return 'shadow-gallery-adjusted';
	}
	
	public function get_title() {
		return esc_html__( 'Gallery: Adjusted', 'shadowcore' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Shadow_Gallery_Adjusted_Widget() );