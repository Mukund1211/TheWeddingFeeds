...
class Shadow_Info_Card_Widget extends Widget_Base {
	
	public function get_name() {
		return 'shadow-info-card';
	}
	
	public function get_title() {
		return esc_html__( 'Info Card', 'shadowcore' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Shadow_Info_Card_Widget() );