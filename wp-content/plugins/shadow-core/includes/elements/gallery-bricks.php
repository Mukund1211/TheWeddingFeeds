...
class Shadow_Gallery_Bricks_Widget extends Widget_Base {
	
	public function get_name() {
		return 'shadow-gallery-bricks';
	}
	
	public function get_title() {
		return esc_html__( 'Gallery: Bricks', 'shadowcore' );
	}
	...
	protected function _register_controls() {		
		...
		$this->add_control(
			'bricks_layout',
			[
				'label' => esc_html__( 'Select Layout', 'shadowcore' ),
				'type' => Controls_Manager::SELECT,
				'default' => '1x2',
				'options' => [
					'1x2' => esc_html__( 'One + Two', 'shadowcore' ),
					'2x3' => esc_html__( 'Two + Three', 'shadowcore' ),
				],
				'prefix_class' => 'shadowcore-bricks-layout--',
			]
		);
	...
	protected function render() {
		...
		?>
		<div class="shadowcore-grid shadowcore-gallery-bricks">
			<?php
			$counter = 0;
			...
			?>
			<div class="shadowcore-gallery-item shadowcore-grid-item <?php echo esc_attr( $bricks_class ); ?>">
...
Plugin::instance()->widgets_manager->register_widget_type( new Shadow_Gallery_Bricks_Widget() );