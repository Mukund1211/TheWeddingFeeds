...
# Menu Walker Edit Class
if ( ! class_exists( 'Shadow_Menu_Walker_Edit' ) ) {
	class Shadow_Menu_Walker_Edit extends Walker_Nav_Menu_Edit {

        function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            
            parent::start_el( $output, $item, $depth, $args, $id );
            
            $custom_fields = Shadow_Menu::$custom_fields;
            ...
            $custom_fields_wrapper->setAttribute( 'class', 'shadow_menu_custom_fields' );
            ...
            foreach ( $custom_fields as $field_key => $field ) {
                ...
                $field_wrapper->setAttribute( 'class', 'shadow_cmf_wrapper' );
                ...
                $label->setAttribute( 'class', 'shadow_cmf_label' );
                ...
                $input->setAttribute( 'class', 'widefat shadow_cmf_' . $field[ 'element' ] .' ' . esc_attr( $field_key ) );
